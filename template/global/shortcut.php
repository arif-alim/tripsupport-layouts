<div class="flex text-center justify-between">
  <a href="<?php echo home_url() ?>/flights" class="<?php if (is_page('flights')) echo 'text-rose-600' ?> flex-1 ">
    <span class=" inline-block rounded-full bg-white shadow-lg p-0.5 mb-2">
      <div class="bg-slate-900 inline-block w-10 h-10 rounded-full flex items-center justify-center">
  ...
  <a href="<?php echo home_url() ?>/vacations" class="<?php if (is_page('vacations')) echo 'text-rose-600'; ?> flex-1">
    <span class="inline-block rounded-full bg-white shadow-lg p-0.5 mb-2">
      <div class="bg-slate-900 inline-block w-10 h-10 rounded-full flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="white">
  ...
  <a href="<?php echo home_url() ?>/hotels" class="<?php if (is_page('hotels')) echo 'text-rose-600'; ?> flex-1">
    <span class="inline-block rounded-full bg-white shadow-lg p-0.5 mb-2">
      <div class="bg-slate-900 inline-block w-10 h-10 rounded-full flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="white">
