...
<main>
  ...
  <!-- Main section -->
  <?php $main_heading = get_post_meta(get_the_ID(), 'vacations_heading_main', true); ?>
  <?php $main_description = get_post_meta(get_the_ID(), 'vacations_description_main', true); ?>
  ...
  <div class="mx-auto max-w-7xl bg-white">
    <section class="pb-12  relative overflow-hidden ">
      ...
      <!-- sub content -->
      <?php $vacations = get_post_meta(get_the_ID(), 'vacation_sub_content', true); ?>
            ...
            <div class="lg:w-2/3 lg:items-center">
              <div class="text-slate-900">
                <h3 class="font-extrabold text-xl lg:text-2xl">
                  <?php echo $vacation['vacation_subheading'] ?>
                </h3>
                <p class="text-tiny sm:text-base mb-1 text-justify">
                  <?php echo $vacation['vacation_subdescription'] ?>
                </p>
              </div>
            </div>
            <!-- image -->
            <?php $vacations_aws_image = "https://trip-support.s3.amazonaws.com/images/vacations/luxury-vacations/europe.jpg"; ?>
            <div class="lg:w-1/3 lg:flex lg:justify-end mt-4">
              <div class="lg:w-full relative">
                <?php if(!empty($vacations['vacation_img'])) { ?>
                  <img src="<?php echo $vacations['vacations_image'] ?>" alt="Vacations image" class="relative rounded-lg mx-auto shadow-lg object-cover">
                <?php } else { ?>
                  <img src="<?php echo $vacations_aws_image ?>" alt="Vacations image" class="relative rounded-lg mx-auto shadow-lg object-cover">
                <?php } ?>
              </div>
            </div>
          </div>
